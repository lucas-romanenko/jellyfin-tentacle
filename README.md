...
### 🎬 VOD Library
- Your provider's movies and series appear in Jellyfin with full metadata — posters, plots, ratings, genres
...
- Native Jellyfin queries for genre/rating playlists — sees your entire library, not just VOD content
...
tentacle:
  ...
  volumes:
    ...
    - /your/vod-movies:/media/vod/movies           # VOD movies
    - /your/vod-shows:/media/vod/shows             # VOD series
...
> - Only mount what you need — skip `/media/movies` and `/media/shows` if you don't use Radarr/Sonarr, skip `/media/vod/...` if you don't have a streaming provider.
